...
function ConfirmationDialog(props: {children: JSX.Element | JSX.Element[], setIsShowDialog: React.Dispatch<React.SetStateAction<boolean>>}) {
    ...
    return (
        <div className="z-30 fixed top-0 left-0 w-full h-full flex justify-center items-center">
            ...
            <div className="absolute bg-white dark:bg-black p-6 rounded-xl sm:w-96 w-11/12 max-height-screen-90 overflow-y-auto">
